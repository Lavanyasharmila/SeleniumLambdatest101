...
public class Main {
	public String username = "sharmilababu5"; 
	public String accesskey = "FV2mJ7QVGjzXoNbtdgKruKkJ9F4xFk3jzZMEk4CmW6W6rhNnrv";
	...
	public void scenario3(String browser, String version, String platform) {
		...
		driver.findElement(By.id("inputEmail4")).sendKeys("sharmilababu5@gmail.com");
		driver.findElement(By.id("inputPassword4")).sendKeys("Lavanya@123");
		...
		driver.findElement(By.id("inputAddress1")).sendKeys("600345");
		driver.findElement(By.id("inputAddress2")).sendKeys("Hari Street");
		driver.findElement(By.id("inputState")).sendKeys("CT");
		driver.findElement(By.id("inputZip")).sendKeys("78560");
